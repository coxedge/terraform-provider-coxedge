...
type ComputeWorkloadPlanRequest struct {
	SelectedPlanId string `json:"selectedPlanId"`
}

type ComputeWorkloadOSRequest struct {
...
func (c *Client) GetComputeWorkloadPlanById(environmentName string, organizationId string, workloadId string) (*WorkloadPlan, error) {
	request, err := http.NewRequest("GET",
		CoxEdgeAPIBase+"/services/"+CoxEdgeComputeServiceCode+"/"+environmentName+"/workload-plan/"+workloadId+"?org_id="+organizationId,
		nil)
	if err != nil {
		return nil, err
	}
	...
	var wrappedAPIStruct WrapperWorkloadPlan
	err = json.Unmarshal(respBytes, &wrappedAPIStruct)
	if err != nil {
		return nil, err
	}
...
func (c *Client) UpdateComputeWorkloadPlan(planRequest ComputeWorkloadPlanRequest, environmentName string, organizationId string, workloadId string) (*TaskStatusResponse, error) {
	//Marshal the request
	jsonBytes, err := json.Marshal(planRequest)
	if err != nil {
		return nil, err
	}
	//Wrap bytes in reader
...
func (c *Client) GetComputeWorkloadOSById(environmentName string, organizationId string, workloadId string) (*ComputeWorkloadOS, error) {
	request, err := http.NewRequest("GET",
	...
	var wrappedAPIStruct WrapperComputeWorkloadOS
	err = json.Unmarshal(respBytes, &wrappedAPIStruct)
	if err != nil {
		return nil, err
	}
...
func (c *Client) UpdateComputeWorkloadOS(osRequest ComputeWorkloadOSRequest, environmentName string, organizationId string, workloadId string) (*TaskStatusResponse, error) {
	//Marshal the request
	jsonBytes, err := json.Marshal(osRequest)
	if err != nil {
		return nil, err
	}
	//Wrap bytes in reader
